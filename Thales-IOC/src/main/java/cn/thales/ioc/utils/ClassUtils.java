...
public class ClassUtils {
    ...
    /**
     * @param classPath
     * @return 用法: cn.thales.ioc.utils.ClassUtils ===> n.thales.ioc.utils
     */
    public static String getBasePackage(String classPath) {
        int i = classPath.lastIndexOf(PACKAGE_SEPARATOR);
        return classPath.substring(0, i);
    }

    public static String getPackageName(Class<?> clazz) {
        return getBasePackage(clazz.getName());
    }
